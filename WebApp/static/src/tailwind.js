 ...
 * Original file: /npm/@tailwindcss/browser@4.1.6/dist/index.global.js
 *
...
(() => {
  var e = 10;
  function t(t, o) {
    let a = o?.from ? { file: o.from, code: t } : null;
    "\ufeff" === t[0] && (t = " " + t.slice(1));
    let i,
      l = [],
      s = [],
      ...
      if (13 !== m || ((i = t.charCodeAt(o + 1)), i !== e))
        if (92 === m) "" === f && (h = o), (f += t.slice(o, o + 2)), (o += 1);
          ...
          if (33 === r.charCodeAt(2)) {
            let t = x(r.slice(2, -2));
            s.push(t), a && ((t.src = [a, e, o + 1]), (t.dst = [a, e, o + 1]));
          }
        } else if (39 === m || 34 === m) {
          let r = o;
          for (let n = o + 1; n < t.length; n++)
            if (((i = t.charCodeAt(n)), 92 === i)) n += 1;
            else {
              if (i === m) {
                o = n;
                break;
              ...
              if (i === e || (13 === i && t.charCodeAt(n + 1) === e))
                throw new Error(
                  `Unterminated string: ${
          ...
          if (
            ...
            (32 === i ||
              i === e ||
              9 === i ||
              (13 === i && (i = t.charCodeAt(o + 2)) && i == e))
          )
            continue;
          if (m === e) {
            if (0 === f.length) continue;
            (i = f.charCodeAt(f.length - 1)),
              32 !== i && i !== e && 9 !== i && (f += " ");
            ...
            for (let n = o + 2; n < t.length; n++)
              if (((i = t.charCodeAt(n)), 92 === i)) n += 1;
                ...
                if (40 === i) e += ")";
                  ...
                  if ((125 === i || t.length - 1 === n) && 0 === e.length) {
                    (o = n - 1), (f += t.slice(r, n));
                    break;
                  }
                  (41 === i || 93 === i || 125 === i) &&
    ...
    if (64 === f.charCodeAt(0)) {
      let e = r(f);
      a && ((e.src = [a, h, t.length]), (e.dst = [a, h, t.length])), l.push(e);
    }
    if (p.length > 0 && u) {
      if ("rule" === u.kind)
  ...
  function ie(e, t) {
    ...
    for (let r of t) if (ae[r]?.(e)) return r;
    return null;
  }
  var le = /^url\(.*\)$/;
  function se(e) {
  ...
  var je = new Set(["inset", "inherit", "initial", "revert", "unset"]),
    Ce = /^-?(\d+|\.\d+)(.*?)$/g;
  function Te(e, t) {
    return R(e, ",")
      .map((e) => {
    ...
    for (let n of t.nodes) {
      ...
      if (
        ...
        if (
          ...
          if (null !== ie(e.value, [t])) return { nodes: m(e.value) };
        }
      }
    }
  }
  ...
  function qe(e, t, r) {
    ...
    return (
      p(n, (e, { replaceWith: n }) => {
        if ("function" === e.kind && e.value in Re) {
          let o = R(h(e.nodes).trim(), ",").map((e) => e.trim());
          return n(m(Re[e.value](r, t, ...o)));
        }
      }),
      h(n)
    );
  ...
  function tt(e) {
    let t = (function (e) {
        ...
        {
          let a = () => z([Ne("--tw-outline-style", "solid")]);
          ...
          (function* (e, t) {
            ...
            if (null === l || null !== u)
              if ("[" !== i[0]) {
                ...
                } else c = P(i, (e) => t.utilities.has(e, "functional"));
                for (let [t, r] of c) {
                  let n = {
                    kind: "functional",
                    root: t,
      ...
      i = new c((e) => {
        let t = (function (e, t) {
          ...
          for (let o of r) {
            let r = lt(o);
            (e.important || t.important) && it(o);
            let i = { kind: "rule", selector: a, nodes: o };
            for (let r of e.variants)
              if (null === ot(i, r, t.variants)) return [];
      ...
      s = {
        ...
        candidatesToCss(e) {
          ...
          for (let r of e) {
            ...
            (n = C(n, s, 0)), 0 === n.length || e ? t.push(null) : t.push(T(n));
          }
          return t;
        },
        getClassOrder(e) {
      ...
      let s = (() => {
        let o = gt(n),
          [i, l] = (function (e, t) {
            ...
            for (let [e, t] of i) yt(u, [e ?? "DEFAULT"], t);
  ...
  function Et({
    ...
    let a = {
      addBase(r) {
        if (o) return;
        let a = Vt(r);
        (n.current |= Pe(a, e)), t.push(k("@layer", "base", a));
      },
      addVariant(t, r) {
        if (!Ge.test(t))
          throw new Error(
  ...
  var Dt = Ut((e) => {
    ...
    Pt = {
      ...
      aspectRatio: { auto: "auto", square: "1 / 1", video: "16 / 9", ...Rt },
  ...
  function Gt(e, { config: t, base: r, path: n, reference: o }) {
    ...
    for (let a of t.presets ?? [])
      Gt(e, { path: n, base: r, config: a, reference: o });
    for (let t of a)
      e.plugins.push(t),
        t.config &&
          Gt(e, {
  ...
  async function cr(
    e,
    { base: t = "", from: r, loadModule: n = lr, loadStylesheet: i = sr } = {}
  ) {
    let l = 0;
    (e = [$({ base: t }, e)]), (l |= await ut(e, t, i, 0, void 0 !== r));
    let c = null,
      u = new s(),
      d = [],
      f = [],
    ...
    A(e, (e, { parent: t, replaceWith: r, context: n }) => {
      if ("at-rule" === e.kind) {
        ...
        if ("@source" === e.name) {
          ...
          } else j.push({ base: n.base, pattern: l, negated: o });
          return void r([]);
        }
        if (
          ("@variant" === e.name &&
  ...
  async function ur(e, r = {}) {
    let n = t(e, { from: r.from }),
      o = await (async function (e, t = {}) {
        ...
        n.unshift(
          x("! tailwindcss v4.1.6 | MIT License | https://tailwindcss.com ")
        );
        let u = new Set(),
          d = null,
          f = 0,
        ...
        return {
          ...
          build(o) {
            ...
            return (
              ...
              s || f !== m.length
                ? ((f = m.length), (i.nodes = m), (d = C(n, r, t.polyfills)), d)
                : ((d ??= C(n, r, t.polyfills)), d)
            );
          },
        };
      })(n, r),
...
//# sourceMappingURL=/sm/aa96f1fd8c338083c18bb7c4dc620e9dea952d8d9e7f8ebb3ac66eaaa80c358d.map
